...
function swiProcessing(dirName)
  ...
  magImgFiles=dir([magImgDir 'SWI_TOTAL_MAG_TE2.nii.gz']); %For phillips this will onbly be 1 file
  phaImgFiles=dir([phaImgDir 'SWI_TOTAL_PHA_TE2.nii.gz']); %For phillips this will only be 1 file
