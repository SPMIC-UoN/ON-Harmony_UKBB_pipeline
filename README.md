...
First install the UK_Biobank Python Conda Environment using `bb_python/python_installation/install_bb_python3.5.1.sh`. Then, set the paths in the `init_vars` script.
