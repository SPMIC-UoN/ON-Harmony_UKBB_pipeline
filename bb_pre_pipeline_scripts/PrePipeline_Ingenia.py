...
f = open("Ingenia_file_name.txt", "w+")
f.write(sys.argv[1])
f.close()
...
subprocess.call(['/home/ppxan2/UK_biobank_pipeline/bb_pre_pipeline_scripts/pre_diffusion_scripts_Ingenia'])
