...
static struct PyModuleDef transform_coordinates_module =
{
    PyModuleDef_HEAD_INIT,
    "_transform_coordinates", /* name of module */
    "",          /* module documentation, may be NULL */
    -1,          /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    transform_coordinatesmethods
};

PyMODINIT_FUNC PyInit_transform_coordinates_ext(void)
{
    import_array();
    return PyModule_Create(&transform_coordinates_module);
}
